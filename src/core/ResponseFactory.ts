...
interface ObjectReferenceResponse {
...
interface FunctionReferenceResponse {
...
type ServerResponse = ObjectReferenceResponse | FunctionReferenceResponse;

interface ResponseFactoryOptions {
    ...
    if (needsSerialization) {
      try {
        ...
        this.options.logger.warn(
          "Serialization failed, storing as reference only",
          {
            error: error instanceof Error ? error.message : String(error),
            resultType: typeof result,
          },
